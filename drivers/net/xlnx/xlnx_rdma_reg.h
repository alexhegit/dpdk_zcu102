...
/*SG datamover registers*/
#define SG_DATAMOVER_BASE       (0x00000000)
#define SG_DATAMOVER_VERSION    (SG_DATAMOVER_BASE + 0x0)
#define SG_DATAMOVER_DATE       (SG_DATAMOVER_BASE + 0x4)
#define SG_DATAMOVER_RST        (SG_DATAMOVER_BASE + 0x8)
#define SG_DATAMOVER_XCACHE     (SG_DATAMOVER_BASE + 0x10) // 0x2
#define SG_DATAMOVER_EOF        (SG_DATAMOVER_BASE + 0x20) // 0x1
#define SG_DATAMOVER_BURST_TYPE (SG_DATAMOVER_BASE + 0x28) // 0x1
#define SG_DATAMOVER_TXRING_START_ADDR_L    (SG_DATAMOVER_BASE + 0x80)
#define SG_DATAMOVER_TXRING_START_ADDR_H    (SG_DATAMOVER_BASE + 0x84)
#define SG_DATAMOVER_RXRING_START_ADDR_L    (SG_DATAMOVER_BASE + 0x100)
#define SG_DATAMOVER_RXRING_START_ADDR_H    (SG_DATAMOVER_BASE + 0x104)

#define SG_DATAMOVER_TXRING_PRODUCER        (SG_DATAMOVER_BASE + 0x88)
#define SG_DATAMOVER_TXRING_CONSUMER        (SG_DATAMOVER_BASE + 0x8c)
#define SG_DATAMOVER_RXRING_PRODUCER        (SG_DATAMOVER_BASE + 0x108)
#define SG_DATAMOVER_RXRING_CONSUMER        (SG_DATAMOVER_BASE + 0x10c)
